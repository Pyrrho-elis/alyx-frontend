...
export default function CreatorPage() {
  ...
  if (loading) return <div className='flex flex-col justify-center gap-4 w-full max-w-sm mx-auto p-4 mb-16'><SkeletonCard /></div>;
  if (error) return <div>Error: {error}</div>;
  if (!creatorData) return <div>Creator not found</div>;
  return (
    <>
      <div className='flex flex-col justify-center gap-4 w-full max-w-sm mx-auto p-4 mb-16'>
        <div className='m-4'>
